...
def gen(model_name, sae_name, sae_id, tokenizer_name, layer, coeff, bg_type, temperature, freq_penalty, seed_num, path, outpath):
    with open(path) as f:
        data = json.load(f)
...
def get_args():
    ...
    parser.add_argument('--eva_set', type=str, default="en_subset")
...
def main():
    ...
    if eva_set == 'en':
        ...
        outpath = f'../data/SAE/saftey_bench/test_en_eva_{model_name}_zeroshot{zero_shot}_prompts.json'
        ...
        path = f'../data/SAE/saftey_bench/test_en_eva_{model_name}_zeroshot{zero_shot}_prompts.json'
        outpath = f'../data/SAE/steer_result/case_study/saftey_bench/{model_name}/test_en_eva_zeroshot{zero_shot}_res.jsonl'
        gen(model_name, sae_name, sae_id, tokenizer_name, layer, coeff, bg_type, temperature, freq_penalty, seed, path, outpath)

        # extract answers from the responses
        path = f'../data/SAE/steer_result/case_study/saftey_bench/{model_name}/test_en_eva_zeroshot{zero_shot}_res.jsonl'
        outpath = f'../data/SAE/steer_result/case_study/saftey_bench/{model_name}/test_en_eva_zeroshot{zero_shot}_res_processed.json'
