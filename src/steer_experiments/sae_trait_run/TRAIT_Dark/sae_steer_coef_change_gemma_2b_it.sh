...
python SAE/sae_run.py \
    ...
    --prompt_type 1 \
    --inference_type chat \
    --save_dir_path ../data/SAE/steer_result/case_study/coeff_change/gemma-2b-it/gemma-2b-it_coeff1000 \
    --testset TRAIT_Dark

python SAE/analysis_dark.py \
    --save_path ../data/SAE/steer_result/case_study/coeff_change/gemma-2b-it/gemma-2b-it_coeff1000 \
    --prompt_type 1 \
    --model_name gemma-2b-it \
    --bg_features ../data/SAE/bg_features/coeff
