...
python SAE/sae_run.py \
    ...
    --bg_type fixed \
    --steer_mode \
    --steer_file_path ../data/SAE/bg_features/p5_n5/gemma-2-9b-it.json \
    --prompt_type 1 \
    --inference_type chat \
    --save_dir_path ../data/SAE/steer_result/p5_n5/gemma-2-9b-it

python SAE/analysis.py \
    --save_path ../data/SAE/steer_result/p5_n5/gemma-2-9b-it \
    --prompt_type 1 \
    --model_name gemma-2-9b-it \
